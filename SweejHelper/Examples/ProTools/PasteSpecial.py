...
# Arguments to pass to the 'pasteSpecial' function
# The pasteSpecialOption should be one of the following:
#   "Merge"
#   "Repeat_To_Fill_Selection"
#   "To_Current_Automation_Type"
arguments = {
    "pasteSpecialOption": "To_Current_Automation_Type"  # Replace with the appropriate PasteSpecialOptions value
}
...
# Send a request to clear special, including the request id and arguments in the URL
def send_message_to_sweejhelper(message):
    # Connection details
    client_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
    client_socket.connect(('localhost', 65500))  # use the same port number as in your Swift application
...
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/pasteSpecial/{request_id}?arguments={encoded_arguments}')