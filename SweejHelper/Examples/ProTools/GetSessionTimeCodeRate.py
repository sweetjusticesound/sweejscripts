...
# Send a request to get the session time code rate, including the request id in the URL
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/getSessionTimeCodeRate/{request_id}')