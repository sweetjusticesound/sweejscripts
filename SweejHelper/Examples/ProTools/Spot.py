...
# Arguments to pass to the 'spot' function
# The 'locationOptions' can be one of the following: "BarsBeats", "MinSecs", "TimeCode", "FeetFrames", "Samples".
# The 'locationType' can be one of the following: "Start", "SyncPoint", "End".
# The 'locationValue' is a string that represents the value of the location, depending on the 'locationOptions' choice.
arguments = {
    "locationOptions": "TimeCode",  # Replace with the desired location option
    "locationType": "Start",  # Replace with the desired location type
    "locationValue": "00:01:30:00"  # Replace with the desired location value
}
...
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/spot/{request_id}?arguments={encoded_arguments}')