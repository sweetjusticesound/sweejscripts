...
# Prepare the arguments for setRecordMode
arguments = {
    "record_mode": "RM_Normal",  # Choose from: "RM_Normal", "RM_Loop", "RM_Destructive", "RM_QuickPunch", "RM_TrackPunch", "RM_DestructivePunch"
    "record_arm_transport": True,  # True or False
}
...
# Prepare the message
message = f'sweejhelper://proToolsFunction/setRecordMode/{request_id}?arguments={arguments_encoded}'

# Send a request to set record mode
