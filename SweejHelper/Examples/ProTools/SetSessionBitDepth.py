...
# Valid bitDepth values: "None", "Bit16", "Bit24", "Bit32Float"
bitDepth = "Bit24"
...
url = f'sweejhelper://proToolsFunction/setSessionBitDepth/{request_id}?arguments={urllib.parse.quote(arguments_string)}'
