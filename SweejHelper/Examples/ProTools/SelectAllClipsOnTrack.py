...
# Arguments to pass to the 'selectAllClipsOnTrack' function
# The 'trackName' should be a string representing the name of the track where all clips are to be selected.
arguments = {
    "trackName": "Track1"  # Replace with the name of the track
}
...
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/selectAllClipsOnTrack/{request_id}?arguments={encoded_arguments}')