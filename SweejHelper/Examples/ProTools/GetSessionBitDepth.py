...
# Send a request to get the session bit depth, including the request id in the URL
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/getSessionBitDepth/{request_id}')
