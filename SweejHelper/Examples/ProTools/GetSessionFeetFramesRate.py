...
# Send a request to get the session feet frames rate, including the request id in the URL
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/getSessionFeetFramesRate/{request_id}')
