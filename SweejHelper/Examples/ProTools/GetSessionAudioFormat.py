...
# Send a request to get the session audio format, including the request id in the URL
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/getSessionAudioFormat/{request_id}')
