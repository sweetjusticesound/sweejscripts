...
# Arguments to pass to the 'getFileLocation' function
# Filter options: "All", "OnTimeline", "NotOnTimeline", "Online", "Offline", "Audio", "Video", "Rendered", "SelectedClipsTimeline", "SelectedClipsClipsList"
arguments = {
    "singleResponseLimit": 5,  # Modify as per your requirement
    "fileFilters": ["All"]  # Modify these filters as per your requirement
}
...
# Send a request to get file location, including the request id and arguments in the URL
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/getFileLocation/{request_id}?arguments={encoded_arguments}')
