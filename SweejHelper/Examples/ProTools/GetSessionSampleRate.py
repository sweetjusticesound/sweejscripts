...
# Send a request to get the session sample rate, including the request id in the URL
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/getSessionSampleRate/{request_id}')