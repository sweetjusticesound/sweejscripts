...
# Send a request to get the session path, including the request id in the URL
send_message_to_sweejhelper(f'sweejhelper://proToolsFunction/getSessionPath/{request_id}')